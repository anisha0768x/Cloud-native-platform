...
async def settings(rsa_keypair):
    ...
    return MetricsServiceSettings(
        DATABASE_URL="postgresql+asyncpg://platform:platform_local_dev_only@localhost:5432/metrics_service_test",
        JWT_PUBLIC_KEY=public_key,
        ENABLE_KAFKA_CONSUMER=False,  # HTTP-layer tests don't need a live broker
    )
