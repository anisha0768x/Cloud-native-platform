...
def make_token(rsa_keypair, *, permissions: list[str], roles: list[str] | None = None) -> str:
...
async def settings(rsa_keypair):
    ...
    return MonitoringServiceSettings(
        DATABASE_URL="postgresql+asyncpg://platform:platform_local_dev_only@localhost:5432/monitoring_service_test",
